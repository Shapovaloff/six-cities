...
function RoomPage() {
  ...
  const isDataLoadedOffer = useSelector(getIsDataLoadedOffer);
  const isDataLoadedReviews = useSelector(getIsDataLoadedReviews);
  const isDataLoadedOffersNearby = useSelector(getIsDataLoadedOffersNearby);
